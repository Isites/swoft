...
namespace Grace\Swoft\Bean\Resource;

use Doctrine\Common\Annotations\AnnotationReader;
use Doctrine\Common\Annotations\AnnotationRegistry;
use Grace\Swoft\Bean\Wrapper\WrapperInterface;
use Grace\Swoft\Helper\ComposerHelper;
...
abstract class AnnotationResource extends AbstractResource
{
     ...
     * @return null
     */
    public function parseBeanAnnotations($className)
    {
     ...
     * @return array
     */
    protected function scanPhpFile($dir, $namespace)
    {
        if (!is_dir($dir)) {
            return [];
        }
     ...
     */
    protected function addIgnoredNames($reader)
    {
     ...
     */
    private function parseClassAnnotations($className, $annotation, $classAnnotations)
    {
        foreach ($classAnnotations as $classAnnotation) {
            ...
            $beanNamespaceTmp    = implode(DIRECTORY_SEPARATOR, array_slice($paths, 0, count($paths) - 2));
